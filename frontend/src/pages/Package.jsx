                ...
                {packageData?.packageDescription.length > 280 ? (
                  <>
                    ...
                    <button
                      id="moreBtn"
                      onClick={() => {
                       <div className="w-20 h-40">{document.getElementById("desc").innerText =
                        packageData?.packageDescription}</div>  
            ...
            <div className="w-full flex flex-col mt-2 items-center">
              {packageRatings && (
                <>
                  ...
                  <div
                    className={`w-full sm:max-w-[640px] gap-2 ${!currentUser || ratingGiven
                        ? "hidden"

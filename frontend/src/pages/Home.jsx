...
const Home = () => {
  ...
  const handleMouseEnter = () => {
    if (iframeRef.current) {
      // Send a postMessage to the iframe to autoplay the video (Vimeo API specific)
  ...
  return (
        ...
        <div className="main p-6 flex flex-col gap-5">
          ...
          {!loading && offerPackages.length > 0 && (
                 ...
                 <div
                   ...
                   onMouseOver={handleMouseEnter} // Autoplay on hover
                 >
                   <iframe
                     ref={iframeRef}
                     title="vimeo-player"
                     src="https://player.vimeo.com/video/53011823?h=0fe67f4a8a"
                     className=" cursor-pointer w-[100vw] h-[calc(100vh-50px)] border-none"
                     allow="autoplay"
                     allowFullScreen
                   ></iframe>
                 </div>
    ...
    //           {/* <iframe title="vimeo-player" src="https://player.vimeo.com/video/53011823?h=0fe67f4a8a" width="640" height="360" frameborder="0" autoPlay allowFullScreen></iframe> */}
    //           <iframe
    //   title="vimeo-player"
    //   src="https://player.vimeo.com/video/53011823?h=0fe67f4a8a"
    //   width="640"
